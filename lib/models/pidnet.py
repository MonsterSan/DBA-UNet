...
class PIDNet(nn.Module):
    ...
    def __init__(self,num_classes, m=2, n=3,  planes=32, ppm_planes=96, head_planes=128, augment=True):
...
if __name__ == '__main__':
    model = PIDNet(num_classes=2,m=2, n=3, planes=32, ppm_planes=96, head_planes=128, augment=False)
    model.eval()
